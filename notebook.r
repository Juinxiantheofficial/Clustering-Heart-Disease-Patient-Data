...
# Load the data
heart_disease <- read.csv("datasets/heart_disease_patients.csv", header=T, sep=',')
...
# Load ggplot2
library(ggplot2)
plot_one = ggplot(heart_disease, aes(age,chol, color=as.factor(first_clust))) + geom_point()
plot_one 

plot_two = ggplot(heart_disease, aes(age,chol, color=as.factor(second_clust))) + geom_point()
plot_two
...
# Plot age and chol
plot_one = ggplot(heart_disease, aes(age,chol,color=as.factor(hc_clust))) + geom_point()
plot_one
# Plot oldpeak and trestbps
plot_two = ggplot(heart_disease, aes(oldpeak,trestbps,color=as.factor(hc_clust)))+geom_point()
plot_two
